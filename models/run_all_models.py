...
def get_best_existing_model():
    ...
    if not artifact_path:
        raise RuntimeError("Could not determine model artifact path from best run")
...
def main():
    parser = argparse.ArgumentParser(description='Train models or use existing best model')
